!function($, wysi) {
	...
	var tpl = {
		"font-styles" : function(locale, options) {
			...
			return "<li class='dropdown'>"
					...
					+ locale.font_styles.h6 + "</a></li>" + "</ul>" + "</li>";
		},
		...
		"emphasis" : function(locale, options) {
			...
			return "<li>"
					...
					+ locale.emphasis.underline + "</a>" + "</div>" + "</li>";
		},
		...
		"lists" : function(locale, options) {
			...
			return "<li>" + "<div class='btn-group'>"
					...
					+ "' tabindex='-1'><i class='fa fa-list-ul'></i></a>"
					+ "<a class='btn btn-default" + size
					+ "' data-wysihtml5-command='insertOrderedList' title='"
					+ locale.lists.ordered
					+ "' tabindex='-1'><i class='fa fa-list-ol'></i></a>"
					+ "<a class='btn btn-default" + size
					...
					+ locale.lists.indent
					+ "' tabindex='-1'><i class='fa fa-dedent'></i></a>"
					+ "</div>" + "</li>";
		},
		...
		"link" : function(locale, options) {
			...
			return "<li>"
					...
					+ "<label style='margin-top:5px;'> <input type='checkbox' class='bootstrap-wysihtml5-insert-link-target' checked>"
					+ locale.link.target
					+ "</label>"
					+ "</div>"
					...
					+ locale.link.insert
					+ "' tabindex='-1'><i class='fa fa-share-square-o'></i></a>"
					+ "</li>";
		},
		...
		"image" : function(locale, options) {
			...
			return "<li>"
					...
					+ "<img src='images/placeholdit.png' alt='' />"
					+ "</div>"
					...
					+ " Change"
					+ "</span>"
					+ "<input type='file' class='default bootstrap-wysihtml5-insert-image-url' />"
					+ "</span>"
					...
					+ "</div>"
					+ "<div class='modal-footer'>"
					+ "<a href='javascript:void(0)' class='btn btn-default reset_form' data-dismiss='modal'>"
					+ locale.image.cancel
					+ "</a>"
					+ "<a href='javascript:void(0)' class='btn btn-primary reset_form' data-dismiss='modal'>"
					+ locale.image.insert
					+ "</a>"
					+ "</div>"
					+ "</div>"
		...
		"html" : function(locale, options) {
			...
			return "<li>" + "<div class='btn-group'>"
					...
					+ locale.html.edit
					+ "' tabindex='-1'><i class='fa fa-pencil'></i></a>"
					+ "</div>" + "</li>";
		},
		...
		"color" : function(locale, options) {
			...
			return "<li class='dropdown'>"
					...
					+ locale.colours.orange + "</a></li>" + "</ul>" + "</li>";
		}
	};
	...
	Wysihtml5.prototype = {
		...
		createEditor : function(options) {
			...
			// Add the toolbar to a clone of the options object so multiple
			// instances
		...
		initInsertImage : function(toolbar) {
			...
			var insertImage = function() {
				var urlDataImage = insertImageModal
						.find('.bootstrap-wysihtml5-insert-image-url-data');
				var urlData = urlDataImage.attr("src");
		...
		initInsertLink : function(toolbar) {
			...
			var targetInput = insertLinkModal
					.find('.bootstrap-wysihtml5-insert-link-target');
	...
	var methods = {
		resetDefaults : function() {
			$.fn.wysihtml5.defaultOptions = $.extend(true, {},
